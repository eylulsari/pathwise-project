...
export const en = {
  ...
  welcome: {
    ...
    body1: 'Tell us your budget, your pace and what you are curious about, and Pathwise builds a day across one Istanbul neighbourhood — with real travel times between stops, not a list of pins.',
    body2: 'Everything is yours to change: drag stops, drop the ones you do not want, and the day recalculates around you.',
    start: 'Show me my day',
    skip: 'Skip',
  },
  auth: {
    ...
    errName: 'Please enter your name — at least two characters.',
    errEmail: 'That does not look like an email address.',
    errPassword: 'Your password needs at least 8 characters.',
    errEmailTaken: 'There is already an account with this address. Try signing in instead.',
    errBadCredentials: 'That email and password do not match. Check them and try again.',
    errTooMany: 'Too many attempts. Please wait a minute and try again.',
    errGeneric: 'Something went wrong on our side. Please try again in a moment.',
    forgotLink: 'Forgot your password?',
    forgotBody: 'We cannot reset passwords by email yet, so please write to us and we will help you back into your account.',
  ...
  museumPass: {
    ...
    estimatedLabel:
      'estimated difference — what these entries would cost bought separately',
    notNetNote:
      'The pass has its own price, and it changes, so we do not quote it here. Check the current price and subtract it yourself to see where you land.',
    checkPrice: 'Check the current pass price',
    uncoveredNote: '{count} other paid stops today are not covered by the pass.',
    approxWarning:
      'These ticket prices are our estimates, not verified prices, and what the pass covers changes. Check the current prices and the current coverage before relying on this.',
  },
  list: {
    loading: 'Loading…',
