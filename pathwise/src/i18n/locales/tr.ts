...
export const tr = {
  ...
  welcome: {
    title: 'Pathwise’a hoş geldin',
    body1: 'Bütçeni, temponu ve neye meraklı olduğunu söyle; Pathwise sana İstanbul’un bir semtinde bir gün kursun — duraklar arası gerçek yol süreleriyle, bir iğne listesiyle değil.',
    body2: 'Her şey senin elinde: durakları sürükle, istemediğini çıkar, gün etrafında yeniden hesaplansın.',
    start: 'Günümü göster',
    skip: 'Geç',
  },
  auth: {
    ...
    errName: 'Adını yazar mısın — en az iki karakter.',
    errEmail: 'Bu bir e-posta adresine benzemiyor.',
    errPassword: 'Şifren en az 8 karakter olmalı.',
    errEmailTaken: 'Bu adresle bir hesap zaten var. Giriş yapmayı dene.',
    errBadCredentials: 'E-posta ve şifre eşleşmiyor. Kontrol edip tekrar dene.',
    errTooMany: 'Çok fazla deneme oldu. Bir dakika bekleyip tekrar dene.',
    errGeneric: 'Bizim tarafımızda bir şeyler ters gitti. Birazdan tekrar dener misin?',
    forgotLink: 'Şifreni mi unuttun?',
    forgotBody: 'Şifreyi henüz e-postayla sıfırlayamıyoruz, o yüzden bize yaz — hesabına dönmen için yardımcı olalım.',
